...
{% endfor %}
(allow file-read* (subpath "{{ home }}/.cache/zig"))
(allow file-write* (subpath "{{ home }}/.cache/zig"))
(allow file-read* (subpath "{{ home }}/Library/Caches/zig"))
(allow file-write* (subpath "{{ home }}/Library/Caches/zig"))
