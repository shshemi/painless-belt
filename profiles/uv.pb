...
{% endfor %}
(allow file-read* (subpath "{{ home }}/Library/Caches/uv"))
(allow file-write* (subpath "{{ home }}/Library/Caches/uv"))
(allow file-read* (subpath "{{ home }}/.cache/uv"))
(allow file-write* (subpath "{{ home }}/.cache/uv"))
(allow file-read* (subpath "{{ home }}/.local/share/uv"))
(allow file-write* (subpath "{{ home }}/.local/share/uv"))
(allow file-read* (subpath "{{ home }}/.config/uv"))
