...
{% endfor %}
(allow file-read* (subpath "{{ home }}/.config/helix"))
(allow file-write* (subpath "{{ home }}/.config/helix"))
(allow file-read* (subpath "{{ home }}/.cache/helix"))
(allow file-write* (subpath "{{ home }}/.cache/helix"))
