...
{% endfor %}
(allow file-read* (subpath "{{ home }}/.netlify"))
(allow file-write* (subpath "{{ home }}/.netlify"))
(allow file-read* (subpath "{{ home }}/Library/Preferences/netlify"))
(allow file-write* (subpath "{{ home }}/Library/Preferences/netlify"))
