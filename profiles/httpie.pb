...
{% endfor %}
(allow file-read* (subpath "{{ home }}/.httpie"))
(allow file-write* (subpath "{{ home }}/.httpie"))
(allow file-read* (subpath "{{ home }}/.config/httpie"))
(allow file-write* (subpath "{{ home }}/.config/httpie"))
