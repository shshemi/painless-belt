...
{% endfor %}
(allow file-read* (literal "{{ home }}/.emacs"))
(allow file-read* (subpath "{{ home }}/.emacs.d"))
(allow file-write* (subpath "{{ home }}/.emacs.d"))
(allow file-read* (subpath "{{ home }}/.config/emacs"))
(allow file-write* (subpath "{{ home }}/.config/emacs"))
