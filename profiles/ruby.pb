...
{% endfor %}
(allow file-read* (literal "{{ home }}/.gemrc"))
...
(allow file-write* (subpath "{{ home }}/.bundle"))
(allow file-read* (literal "{{ home }}/.irb_history"))
(allow file-write* (literal "{{ home }}/.irb_history"))
