...
{% endfor %}
(allow file-read* (literal "{{ home }}/.psqlrc"))
(allow file-read* (literal "{{ home }}/.psql_history"))
(allow file-write* (literal "{{ home }}/.psql_history"))
(allow file-read* (literal "{{ home }}/.pgpass"))
(allow file-read* (literal "{{ home }}/.pg_service.conf"))
