...
{% endfor %}
(allow file-read* (literal "{{ home }}/.nanorc"))
(allow file-read* (subpath "{{ home }}/.config/nano"))
(allow file-write* (subpath "{{ home }}/.config/nano"))
(allow file-read* (subpath "{{ home }}/.nano"))
(allow file-write* (subpath "{{ home }}/.nano"))
