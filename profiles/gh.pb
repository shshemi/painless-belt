...
(allow file-read* (subpath "{{ home }}/.local/state/gh"))
(allow file-write* (subpath "{{ home }}/.local/state/gh"))
(allow file-read* (subpath "{{ home }}/.local/share/gh"))
(allow file-write* (subpath "{{ home }}/.local/share/gh"))
