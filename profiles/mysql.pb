...
{% endfor %}
(allow file-read* (literal "{{ home }}/.my.cnf"))
(allow file-read* (literal "{{ home }}/.mylogin.cnf"))
(allow file-read* (literal "{{ home }}/.mysql_history"))
(allow file-write* (literal "{{ home }}/.mysql_history"))
