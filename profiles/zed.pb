...
{% endfor %}
(allow file-read* (subpath "{{ home }}/.config/zed"))
(allow file-write* (subpath "{{ home }}/.config/zed"))
(allow file-read* (subpath "{{ home }}/Library/Application Support/Zed"))
(allow file-write* (subpath "{{ home }}/Library/Application Support/Zed"))
